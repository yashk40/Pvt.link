    ...
    return (
        <KeyboardAvoidingView style={styles.root} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
            <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
                ...
                <Text style={styles.subtext}>Sign in to continue managing your devices</Text>
...
const styles = StyleSheet.create({
    ...
    forgotText: { fontSize: FONTS.sizes.sm, color: '#0F766E', fontWeight: FONTS.weights.medium, fontFamily: 'Poppins_500Medium' },
    btn: {
        paddingVertical: 16,
        borderRadius: 16,
        flexDirection: 'row',
